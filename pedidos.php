...
<body>
    ...
    <main>
        ...
        if ($result->num_rows > 0) {
            echo "<table border='1'>";
            echo "<tr><th>ID</th><th>Nome</th><th>Mesa</th><th>Hora</th><th>OBS</th><th>Itens</th><th>Valor</th><th>Funcionário</th><th>Editar</th><th>Excluir</th></tr>";
            ...
            while ($row = $result->fetch_assoc()) {
                ...
                echo "<td><button class='edit' onclick='alternaEdicao(" . $row["id_pedido"] . ")'>Editar</button></td>";
                echo "<td><button class='delete' onclick='excluirPedido(" . $row["id_pedido"] . ")'>Excluir</button></td>";
                echo "</tr>";
            }
